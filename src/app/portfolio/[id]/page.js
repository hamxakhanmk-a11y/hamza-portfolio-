            ...
            <div className="flex flex-col gap-5 lg:sticky lg:top-28 lg:gap-6">
              ...
              {artwork.available ? (
                <a
                  ...
                  className="mt-2 flex w-full items-center justify-center gap-3 bg-[#075f8f] px-5 py-4 text-center text-xs uppercase tracking-[0.16em] text-white transition-colors hover:bg-[#ed7189] sm:w-auto sm:self-start sm:px-8 sm:tracking-[0.2em]"
                >
